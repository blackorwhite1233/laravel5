	...
	<ol class="breadcrumb breadcrumb-quirk">
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <hr>
                <form id="Formcreate" method="POST" action="{{URL::to('admin/Post/edit')}}" class="form-horizontal">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <input type="hidden" name="post_id" value="{{$post_id}}">
                  <div class="form-group">
                    <label class="col-sm-3 control-label"> ID <span class="text-danger"></span></label>
                    <div class="col-sm-8">
                      <input type="text" name="post_id" class="form-control" value="{{$post_id}}" />
                    </div>
                    ...
                    <label class="col-sm-3 control-label">  <span class="text-danger"></span></label>
                    <div class="col-sm-8">
                      <input type="text" name="post_file1" class="form-control" value="{{$post_file1}}" />
                    </div>
                  </div>
