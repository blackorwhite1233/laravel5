  ...
  $('#btn_delete').click(function(event) {
        ...
        if(flag){
          if(confirm('Are you sure delete rows ?')){
            $("#form").attr('action','{{ URL::to("admin/Post/del")}}');
            $("#form").submit();
          }
        }else{
...
@section('content')
	<ol class="breadcrumb breadcrumb-quirk">
      ...
      <div class="panel">
        ...
        <form id="form" method="post" action="{{URL::to('/admin/Post/multisearch')}}">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="panel-body">
          <div class="table-responsive">
            <div class="row">
                <div class="col-sm-6">
                  <a href="{!!URL::to('admin/Post/add')!!}" id="btn_create" class="btn btn-primary btn-quirk">{{trans('admin.create')}}</a>
            ...
            <table  style="margin-top: 10px;margin-bottom: 10px" id="dataTable1_wrapper" class="table table-hover nomargin">
              ...
              <tbody>
                  ...
                  {!!Helper::buildFormSearch($module,'search')!!}
                    ...
                    {!!Helper::buildFormData($module,$items,'post_id','Post')!!}
