...
@section('content')
	<ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{URL::to('admin/Page')}}"><i class="fa fa-home mr5"></i> Page </a></li>
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <hr>
                <form id="Formcreate" method="POST" action="{{URL::to('admin/Page/edit')}}" class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="radio" name="status" class="form-control"  />
                    </div>
                  </div><div class="form-group">
