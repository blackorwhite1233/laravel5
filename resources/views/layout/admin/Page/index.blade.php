  ...
  $('#btn_delete').click(function(event) {
        ...
        if(flag){
          if(confirm('{{trans("admin.confirm_delete")}}')){
            $("#form").attr('action','{{ URL::to("admin/Page/del")}}');
            $("#form").submit();
          }
        }else{
...
@section('content')
	<ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">{{trans('admin.manager_page')}}</li>
      </ol>

      <div class="panel">
        <div class="panel-heading">
          <h4 class="panel-title">{{trans('admin.list_page')}}</h4>
        </div>
        <form id="form" method="post" action="{{URL::to('/admin/Page/multisearch')}}">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="panel-body">
          <div class="table-responsive">
            <div class="row">
                <div class="col-sm-6">
                  <a href="{!!URL::to('admin/Page/add')!!}" id="btn_create" class="btn btn-primary btn-quirk">{{trans('admin.create')}}</a>
            ...
            <table  style="margin-top: 10px;margin-bottom: 10px" id="dataTable1_wrapper" class="table table-hover nomargin">
              ...
              <tbody>
                  ...
                  {!!Helper::buildFormSearch($module,'search')!!}
                    ...
                    {!!Helper::buildFormData($module,$items,'pageID','Page')!!}
          ...
          <div class="row">
          	...
          	<div class="col-sm-2">
                  ...
                  <option value="ASC">{{trans('admin.deascsc')}}</option>
                </select>
          	</div>
          	<div class="col-sm-3">
