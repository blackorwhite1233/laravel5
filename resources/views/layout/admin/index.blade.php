...
<!-- Mirrored from themepixels.com/demo/webpage/quirk/templates/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Aug 2015 06:35:02 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title><?php echo  isset($page) ? $page['title'] . " | Admin Dashboard" : 'Admin Dashboard'; ?> </title>

  {!! HTML::style('admin/lib/Hover/hover.css') !!}
  {!! HTML::style('admin/lib/fontawesome/css/font-awesome.css') !!}
  {!! HTML::style('admin/lib/weather-icons/css/weather-icons.css') !!}
  {!! HTML::style('admin/lib/ionicons/css/ionicons.css') !!}
  {!! HTML::style('admin/lib/jquery-toggles/toggles-full.css') !!}
  {!! HTML::style('admin/lib/morrisjs/morris.css') !!}
  ...
  <div class="leftpanel">
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-tabs nav-justified nav-sidebar">
        ...
        <li class="tooltips" data-toggle="tooltip" title="Log Out"><a href="{!!URL::to('/auth/logout')!!}"><i class="fa fa-sign-out"></i></a></li>
      </ul>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="mainmenu">
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
            <li class="active"><a href="{{URL::to('admin/dashboard')}}"><i class="fa fa-home"></i> <span>{{trans('admin.dashboard')}}</span></a></li>
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
            <li class="nav-parent">
              <a href="#"><i class="fa fa-check-square"></i> <span>{{trans('admin.user')}}</span></a>
              <ul class="children">
                <li><a href="{{URL::to('admin/user')}}">{{trans('admin.user')}}</a></li>
                <li><a href="{{URL::to('admin/group')}}">{{trans('admin.group')}}</a></li>
...
{!! HTML::script('admin/lib/jquery/jquery.js') !!}
{!! HTML::script('admin/lib/jquery-ui/jquery-ui.js') !!}
{!! HTML::script('admin/lib/bootstrap/js/bootstrap.js') !!}
{!! HTML::script('admin/lib/jquery-toggles/toggles.js') !!}
{!! HTML::script('admin/lib/morrisjs/morris.js') !!}
{!! HTML::script('admin/lib/raphael/raphael.js') !!}
{!! HTML::script('admin/lib/flot/jquery.flot.js') !!}
{!! HTML::script('admin/lib/flot/jquery.flot.resize.js') !!}
{!! HTML::script('admin/lib/flot-spline/jquery.flot.spline.js') !!}
{!! HTML::script('admin/lib/jquery-knob/jquery.knob.js') !!}
{!! HTML::script('admin/js/quirk.js') !!}

@yield('script')
</body>

<!-- Mirrored from themepixels.com/demo/webpage/quirk/templates/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Aug 2015 06:35:35 GMT -->
</html>
